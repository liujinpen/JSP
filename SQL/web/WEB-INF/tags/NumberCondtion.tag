...
<%@tag import="java.sql.*" %>
<%@ tag import="com.sun.org.apache.bcel.internal.generic.Select" %>
...
<%
    ...
    try{
        ...
        while(rsl.next()) {
            ...
            String condition="SELECT * FROM people WHERE number= '"+number+"'";
    ...
    jspContext.setAttribute("queryResultByNumber",result.toString());
%>